...
filepath = '"C:\PBL SE\Plant-Leaf-Disease-Prediction-main\model.h5"'
...
tomato_plant = cv2.imread('"C:\PBL SE\Plant-Leaf-Disease-Prediction-main\Dataset\test\Tomato___Bacterial_spot (1).JPG"')
